...
urlpatterns = [
   ...
   path('no_acess/', views.no_acess, name='no_acess'),
...
path("tawaf-wida/", views.tawaf_wida, name="tawaf_wida"),
     ...
     path('iran-guide/', views.iran, name='iran'),
      path('iraq-guide/', views.iraq, name='iraq'),
       path('najaf/', views.najaf, name='najaf'),
        path('kazmin/', views.kazmin, name='kazmin'),
          path('samarra/', views.samarra, name='samarra'),
