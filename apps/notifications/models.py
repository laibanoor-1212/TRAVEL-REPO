...
class Notification(models.Model):
    NOTIFICATION_TYPES = [
        ...
        ('agent_new_booking', 'New Booking Received for Agency'),
        ('agent_doc_resubmitted', 'Customer Resubmitted Documents'),
        ('agent_booking_cancelled', 'Customer Cancelled Booking'),
        ('doc_approved', 'Document / Field Approved'),
        ('doc_rollback_requested', 'Document Rollback Requested'),
        ('kyc_submitted', 'KYC Submitted'),
        ('kyc_pending', 'KYC Pending'),
        ('kyc_approved', 'KYC Approved'),
        ('kyc_rejected', 'KYC Rejected'),
        ...
        ('booking_completed', 'Booking Completed'),
        ('booking_refunded', 'Booking Refunded'),
        ('doc_submitted', 'Documents Submitted by Customer'),
        ('doc_resubmitted', 'Documents Resubmitted by Customer'),
        ('ticket_uploaded', 'E-Ticket Uploaded'),
        ('ticket_issued', 'Ticket Issued'),
        ('traveler_added', 'Traveler Added'),
        ('traveler_updated', 'Traveler Updated'),
        ('escrow_funded', 'Escrow Funded'),
        ('escrow_released', 'Escrow Released to Agent'),
        ...
        ('hotel_voucher_issued', 'Hotel Voucher Issued'),
        ('flight_ticket_uploaded', 'E-Ticket Uploaded'),
        ('new_chat_message', 'New Chat Message'),
        ('admin_joined_chat', 'Admin Joined Chat'),
        ('agency_verified', 'Agency Verified by Admin'),
        ('agency_suspended', 'Agency Suspended'),
        ('admin_broadcast', 'Admin Broadcast Announcement'),
    ]
