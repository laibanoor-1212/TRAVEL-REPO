...
SECRET_KEY = 'django-insecure-83&3)=7oua#q!yu3i5x@v93n-7d6rc4zkv&_=*xbx4^b)^+%-='
...
# Double MEDIA_ROOT & EMAIL_BACKEND settings ko saaf karke sirf yeh SMTP configuration rakhein:
...
EMAIL_HOST_USER = config('EMAIL_HOST_USER', default='safareharam.offcial1212@gmail.com')
